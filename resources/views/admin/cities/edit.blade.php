            ...
            <div class="col m8 s12 animated fadeInLeft">
                <div class="card card-default">
                    <div class="card-content animate fadeUp">
                        ...
                        <div class="row">
                            <div class="col s12">
                                <form action="{{ url('admin/cities/'.$city->id) }}" id="store_user" enctype="multipart/form-data" method="POST" class="col s12">
                                    @csrf
                                    @method('PUT')
                                    
<div class="row">
                                    <div class="input-field">
                                        <input type="text" required name="name" id="name" value="{{ $city->name }}">
