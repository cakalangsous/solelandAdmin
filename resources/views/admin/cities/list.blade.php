                                            ...
                                            <tbody>
                                                @foreach ($cities as $cities)
                                                    <tr>
                                                        ...
                                                        <td class="d-flex">
                                                            <a class="btn btn-small blue darken-2 mr-2 waves-effect waves-light" href="{{ url('admin/cities/'.$cities->id.'/edit') }}"><i class="material-icons">edit</i></a>
                                                            <form action="{{ url('admin/cities/'.$cities->id) }}" name="cities{{ $cities->id }}form" data-data="{{ $cities->id }}" class="delete-form" method="POST">
                                                                @csrf
                                                                @method('DELETE')
