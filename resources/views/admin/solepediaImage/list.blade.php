                                            ...
                                            <tbody>
                                                @foreach ($solepedia_images as $solepedia_image)
                                                    <tr>
                                                        ...
                                                        <td>{{ $solepedia_image->solepedia_id }}</td>
                                                        ...
                                                        <td class="d-flex">
                                                            ...
                                                            <form action="{{ url('admin/solepedia_images/'.$solepedia_image->id) }}" name="solepedia_image{{ $solepedia_image->id }}form" data-data="{{ $solepedia_image->id }}" class="delete-form" method="POST">
                                                                @csrf
                                                                @method('DELETE')
