                                ...
                                <div class="card-content">
                                    ...
                                    <div class="row">
                                        <div class="col s12">
                                            ...
                                            <div class="row">
                                                <form class="col s12" method="POST" action="/admin/users/{{ $user->id }}" enctype="multipart/form-data">
                                                    @method('PUT')
                                                    @csrf
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <input id="email" type="email" value="{{ old('email', $user->email) }}" name="email">
                                                        ...
                                                        <div class="input-field col s12">
                                                            <select name="role" id="role">
                                                                @foreach ($roles as $role)
                                                                    <option value="{{ $role->id }}" @if (old('role', $role_id[0]) == $role->id) selected @endif>{{ $role->name }}</option>
                                                                @endforeach
                                                            </select>
                                                            @error('role')
                                                                <small class="errorName">
